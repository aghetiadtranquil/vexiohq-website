...
The Services, including all software, content, designs, logos, trademarks, and documentation, are owned by or licensed to VexioHQ and are protected by intellectual property laws. You may not copy, modify, distribute, sell, or create derivative works without our prior written consent.

If you provide feedback or suggestions regarding the Services, you grant us the right to use such feedback without restriction or compensation to you.

### 1.6 Service Modifications and Termination

We reserve the right to modify, suspend, or discontinue any part of the Services at any time with or without notice. We may also suspend or terminate your account for violation of these Terms or for any other reason at our sole discretion.
...
Our total liability for any claims arising from these Terms or your use of the Services shall not exceed the greater of (a) the amount you paid to us in the 12 months preceding the claim, or (b) $100 USD.
...
Any disputes arising from these Terms or the Services shall first be attempted to be resolved through good-faith negotiation. If the dispute cannot be resolved within 30 days, either party may pursue binding arbitration in San Francisco, California, administered by JAMS under its Comprehensive Arbitration Rules.
...
By providing your mobile phone number and opting in to our SMS program, you expressly consent to receive text messages from VexioHQ and its product lines (VexioSales, VexioMarketing, VexioHRM, VexioExpense). This consent is not a condition of purchase.
...
- **Promotional Messages:** Special offers, promotions, product updates (with separate consent)
- **AI Agent Communications:** Responses from our AI voice and text agents

### 3.3 Message Frequency

Message frequency varies based on your account activity and preferences. Transactional messages are sent as needed. Promotional messages are typically sent no more than 4 times per month.
...
After texting STOP, you will receive one final confirmation message. Transactional messages related to security and account access may continue as required for service delivery.
...
By providing your phone number and opting in, you consent to receive phone calls from VexioHQ, including calls made using automated dialing systems and pre-recorded messages, for transactional and promotional purposes.
...
Our AI voice agents are designed to identify themselves as AI at the beginning of each call. You may request to speak with a human representative at any time.
...
### 6.2 Data Processor Responsibilities
...
VexioHQ uses third-party sub-processors to provide our Services. A list of current sub-processors is available upon request. We will notify you of any changes to sub-processors and you may object within 30 days.
...
- **AI Decisions:** AI recommendations for hiring/HR decisions require human review
- **Compliance:** You are responsible for compliance with employment laws
- **Data Retention:** Employee data retention must comply with applicable laws

### 8.4 VexioExpense Terms
...
- **Tax Compliance:** Not a substitute for professional tax advice
- **Data Security:** Financial data is encrypted and stored securely

### 8.5 Future Products

VexioHQ may introduce additional products and services. By continuing to use our Services after new products are released, you agree to be bound by any additional terms specific to those products. We will notify you of material changes to our product offerings.
...
- You may request immediate data export before cancellation
...
- **VexioSales:** AI-powered sales intelligence platform
...
These Terms, together with our Privacy Notice, Cookie Notice, and any product-specific agreements, constitute the entire agreement between you and VexioHQ regarding the Services.
