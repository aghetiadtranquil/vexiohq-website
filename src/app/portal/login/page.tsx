        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg className="w-5 h-5 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M3 8L12 13L21 8M3 8V16C3 17.1046 3.89543 18 5 18H19C20.1046 18 21 17.1046 21 16V8M3 8L12 3L21 8" />
                  </svg>
                </div>
                <input
                  id="email"
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/portal/forgot-password" className="text-sm text-blue-600 hover:text-blue-500">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            ...
            <button className="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#0078D4">
                <path d="M11.5 3v8.5H3V3h8.5zm0 9.5v8.5H3V12.5h8.5zm9.5-9.5v8.5H12.5V3H21zm0 9.5v8.5H12.5V12.5H21z"/>
              </svg>
