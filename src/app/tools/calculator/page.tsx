...
export default function BusinessTransformationCalculator() {
  ...
  // No need for state - we'll use iframe for proper JS execution
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      {/* User info bar - simplified since main nav is in layout */}
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-3">
            <h1 className="text-lg font-medium text-gray-900">Business Tools Portal</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2" itemScope itemType="https://schema.org/BreadcrumbList">
            ...
            <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              <Link href="/tools" className="text-gray-500 hover:text-gray-700" itemProp="item">
            ...
            <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              <span className="text-gray-900 font-medium" itemProp="name">ROI Calculator</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          {/* Embedded Calculator using iframe for proper JS execution */}
