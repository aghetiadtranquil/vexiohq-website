...
export const metadata: Metadata = {
  title: 'AI Readiness Assessment | Evaluate Your Organization | DataTranquil',
  ...
  openGraph: {
    title: 'AI Readiness Assessment - Evaluate Your AI Maturity | DataTranquil',
    ...
    url: 'https://datatranquil.com/agentic-ai-assessment',
    type: 'website',
    images: [
      {
        url: 'https://datatranquil.com/og-ai-assessment.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://datatranquil.com/twitter-ai-assessment.jpg'],
  },
  alternates: {
    canonical: 'https://datatranquil.com/agentic-ai-assessment',
  },
  robots: {
    index: true,
    follow: true,
